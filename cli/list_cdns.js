...
function list_cdns(host, port, user, password, callback) {
    var url = util.format("http://%s:%d/cdns/list", host, port);
...
(function main() {
    ...
    try {
        ...
        list_cdns(host, port, client_config.user, client_config.password, function(err, result) {
            if(err) {
